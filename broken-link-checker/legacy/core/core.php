...
require BLC_DIRECTORY_LEGACY . '/includes/screen-options/screen-options.php';
require BLC_DIRECTORY_LEGACY . '/includes/screen-meta-links.php';
...
if ( ! class_exists( 'wsBrokenLinkChecker' ) ) {
	...
	class wsBrokenLinkChecker {
		...
		public function admin_menu() {
			...
			$menu_title = __( 'Broken Links (Old)', 'broken-link-checker' );
			...
			if ( WPMUDEV_BLC\Core\Utils\Utilities::is_subsite() ) {
				$page_controler_v2   = WPMUDEV_BLC\App\Admin_Pages\Dashboard\Controller::instance();
				$submenu_parent_slug = 'view-broken-links';
				$settings_menu_title = __( 'Settings', 'broken-link-checker' );
				$links_page_hook     = add_menu_page(
					__( 'Broken Links', 'broken-link-checker' ),
					__( 'Broken Links', 'broken-link-checker' ),
					'edit_others_posts',
					...
					$page_controler_v2->__get( 'icon_url' )
				);
			} else {
			...
			$options_page_hook = add_submenu_page(
				$submenu_parent_slug,
				__( 'Legacy Settings', 'broken-link-checker' ),
				$settings_menu_title,
				'manage_options',
                                        ...
                                        <td>
                                            <p style="margin-top: 0;">
                                                <label for='send_email_notifications'>
                                                    <input type="checkbox" name="send_email_notifications"
                                            ...
                                            <p>
                                                <label for='send_authors_email_notifications'>
                                                    <input type="checkbox" name="send_authors_email_notifications"
                                                           id="send_authors_email_notifications"
														<?php
                                        ...
                                        <td>
                                            <p style="margin-top: 0; margin-bottom: 0.5em;">
                                                <label for='mark_broken_links'>
                                                    <input type="checkbox" name="mark_broken_links"
                                                           id="mark_broken_links"
														<?php
					...
					?>
                                            ...
                                            <p style="margin-bottom: 0.5em;">
                                                <label for='mark_removed_links'>
                                                    <input type="checkbox" name="mark_removed_links"
                                                           id="mark_removed_links"
														<?php
					...
					?>
                                            ...
                                            <p>
                                                <label for='nofollow_broken_links'>
                                                    <input type="checkbox" name="nofollow_broken_links"
                                                           id="nofollow_broken_links"
														<?php
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td>
                                            <label>
                                                <input type="checkbox" name="suggestions_enabled"
                                                ...
                                                <p>
                                                    ...
                                                    <select name="clear_log_on" id="clear_log_on">
														...
														foreach ( $schedules as $key => $schedule ) {
															...
															?>
                                                            <option
																<?php echo $selected; ?>value="<?php echo esc_attr( $key ); ?>"> <?php echo esc_html( $schedule['display'] ); ?></option>
															<?php
														}
														?>
